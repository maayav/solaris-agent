...
If realtime is not working, run this in the SQL Editor:
...
2. ⬜ Switch to Code mode to implement backend
3. ⬜ Copy Red Team agents from swarm module
